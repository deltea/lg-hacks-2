...
const descriptions = [
    "pass the melody, lose the meaning..split",
    "the telephone game, but in sound.",
    "melodies get lost in translation.",
    "where songs go to evolve—or fall apart.",
    "compose, distort, repeat.",
    "hear your song slowly break.",
    "music's game of broken telephone.",
    "every note tells a different story.",
    "the rhythm of misunderstanding.",
    "compose, interpret, mishear.",
    "your melody won't survive the chain.",
    "the music version of gartic phone.",
    "one tune, many interpretations.",
    "how far can a melody drift?",
    "when composition meets chaos.",
    "play, listen, guess—musically.",
    "musical chaos passed player to player.",
    "every replay reshapes the song.",
    "a melody's journey through confusion.",
    "what happens when music plays telephone.",
    "the melody mutates.",
    "songs evolve through mistakes.",
    "compose. confuse. collapse.",
    "telephone but with instruments.",
    "music passed through human error.",
    "where no song sounds the same twice.",
    "a broken telephone for your ears.",
    "from harmony to havoc.",
    "melodies in translation.",
    "everyone hears something different.",
    "from tune to chaos in five turns.",
    "compose it once, break it forever.",
    "songs that mutate like whispers.",
    "a musical whisper game.",
    "the sound of lost meaning.",
    "where music goes to get misunderstood.",
    "melodies that don't survive the message chain.",
    "listen, replay, distort.",
    "every mistake makes it better.",
    "musical telephone with friends.",
    "guess the melody—wrongly.",
    "how far can your melody travel?",
    "music without memory.",
    "the sound of miscommunication.",
    "remix through confusion.",
    "chaos in perfect rhythm.",
    "the song changes every time.",
    "pass the beat, see what survives.",
    "everyone hears something else.",
    "the sound of collective confusion.",
    "create, distort, enjoy.",
    "no song survives contact with friends.",
    "what if gartic phone had sound.",
    "your melody, reimagined horribly.",
    "a game of melody distortion.",
    "everyone's version of your song.",
    "the tune telephone experiment.",
    "how wrong can music go.",
    "compose once, regret forever.",
    "the melody chain reaction.",
    "from tune to trainwreck.",
    "a broken telephone for musicians.",
    "songs through the noise.",
    "hear your song lose itself.",
    "when melodies misbehave.",
    "your song, their interpretation.",
    "collaborative chaos in sound.",
    "make music, not sense.",
    "where rhythm meets confusion.",
    "the art of musical misunderstanding.",
    "compose blindly, listen wisely.",
    "guess the tune, miss the point.",
    "melody in translation.",
    "one riff, infinite outcomes.",
    "collective music gone wrong.",
    "a symphony of confusion.",
    "the sound of interpretation.",
    "telephone—but make it melodic.",
    "broken melodies, shared laughter.",
    "distortion as collaboration.",
    "music's chaotic social experiment.",
    "play telephone with sound.",
    "every replay tells a new story.",
    "compose. listen. distort. repeat.",
    "the game where songs mutate.",
    "melodies through the grapevine.",
    "collaborative mishearing.",
    "gartic phone for your ears.",
    "watch your melody evolve—or die.",
    "where music mutates faster than memes.",
    "chaos in 8 bars or less.",
    "the evolution of a song gone wrong.",
    "one melody, endless misinterpretations.",
    "sound broken by creativity.",
    "remix the misunderstanding.",
    "a musical experiment in memory.",
    "your song's slow descent into noise.",
    "compose something worth breaking.",
    "melodies passed down like rumors.",
    "the fun of forgetting the melody."
];
