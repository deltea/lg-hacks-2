...
<div class="flex flex-col justify-evenly items-center h-full gap-4">
  <form action="lobby" class="flex flex-col items-center h-full justify-between gap-12">
    ...
    <div class="flex gap-4">
      <a href="/play?username={username}&hosting=true" class="border-2 border-fg font-bold rounded-xl px-4 py-2 cursor-pointer flex items-center gap-3">
